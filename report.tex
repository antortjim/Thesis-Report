...
\begin{figure}[!h]
\centering
\includegraphics[width=0.7\textwidth]{mbr_summary}
\caption{Count of identifications on each run segreagated by source. More than 4k spectra were identified and validated by SearchGUI+peptideShaker. In this particular case, hundreds of new identifications were accomplished.}
