...
\subsection{Peptide to spectrum matching step was successful}

The reanalysis of the proteome benchmark started with the preprocessing of the RAW files produced by the mass spectrometer into an open format that can be handled by downstream tools, such as SearchGUI.

SearchGUI and PeptideShaker su

Identifications decrease with the fraction
Many spectra cannot be matched -> de novo, modification handling, etc
Several search engines improve identifications
